            ...
            <div class="row">
                <div class="col">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">All Company List</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="row card-body">
                        <div class="col-10">
                            <h5 class="card-title">All Company List</h5>
                        </div>
                        <div class="col-2 float-right">
                            <a href="{{ route('company.create') }}" class="btn btn-primary btn-sm">
                                <i class="fa fa-plus-circle me-2" aria-hidden="true"></i>Company
                            </a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-export d-flex">
                                            <a href="{{ route('company.edit', $value->id) }}" class="btn btn-warning btn-sm text-dark">
