                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="input-block mb-3">
                                            ...
                                            <input type="text" name="weight" id="weight" class="form-control @error('weight') is-invalid @enderror" value="{{ $weight->weight }}" placeholder="Enter Weight">
                                            <input type="hidden" name="unit_id" id="unit_id" class="form-control @error('unit_id') is-invalid @enderror" value="{{ $weight->unit_id }}" >
                                            @error('weight')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
