                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="input-block mb-3">
                                                ...
                                                <input type="text" id="invoice_no" name="invoice_no" class="form-control @error('invoice_no') is-invalid @enderror" value="{{ old('invoice_no') }}" placeholder="Enter Invoice No.">
                                                @error('invoice_no')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="input-block mb-3">
                                                ...
                                                <div class="cal-icon cal-icon-info">
                                                    <input type="text" id="invoice_dt" name="invoice_dt" class="form-control datetimepicker @error('invoice_dt') is-invalid @enderror" value="{{ old('invoice_dt') }}" placeholder="Enter Invoice Date">
                                                    @error('invoice_dt')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="col-lg-4 col-md-6 col-sm-12">
                                            <div class="input-block mb-3">
                                                ...
                                                <input type="text" id="package_charges" name="package_charges" class="form-control @error('package_charges') is-invalid @enderror" value="{{ old('package_charges') }}" placeholder="Enter Package Charges">
...
{{-- <script>
    $(document).ready(function(){
        $('#customer_id').on('change', function() {
            ...
            $.ajax({
                method: 'POST',
                url: "{{ route('invoice.getParcelList') }}",
                data: {
                    customerId: customer_id,
                    _token : '{{ csrf_token() }}'
                },
                success: function(response) {
                    $('#total_amount').val(response.getParcelList);
                }
            });
        });
    });
