!(function () {
    var i, c, e, b, j, o, f, g, k, d, p, q, a, E, y, I, l = localStorage.getItem("language");
    if ($('.sidebar').length > 0) {
        ...
        document.querySelectorAll(".navbar-nav .collapse") && ((a = document.querySelectorAll(".navbar-nav .collapse")), Array.from(a).forEach(function (a) {
            ...
            a.addEventListener("show.bs.collapse", function (c) {
                ...
                c ? ((d = c.querySelectorAll(".collapse")), Array.from(d).forEach(function (a) {
                    ...
                    2 < a.childNodes.length && a.firstElementChild.setAttribute("aria-expanded", "false"), (a = a.querySelectorAll("*[id]")), Array.from(a).forEach(function (a) {
                        a.classList.remove("show"), 2 < a.childNodes.length && ((a = a.querySelectorAll("ul li a")), Array.from(a).forEach(function (a) {
                            a.hasAttribute("aria-expanded") && a.setAttribute("aria-expanded", "false");
                        }));
                    });
                }));
            }), a.addEventListener("hide.bs.collapse", function (b) {
                b.stopPropagation(), (b = a.querySelectorAll(".collapse")), Array.from(b).forEach(function (a) {
    ...
    function t() {
        var c, a, d = document.documentElement.getAttribute("data-layout"),
        ...
        b && ("twocolumn" == d || "twocolumn" == b["data-layout"]) && ((document.querySelector(".sidebar").innerHTML = z), ((c = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="assets/img/logo.png" alt="User Image" height="22"></a>'), Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function (b) {
            ...
            }), b.parentElement.classList.contains("twocolumn-item-show") && b.classList.add("active"), d.appendChild(a), c.appendChild(d), a.classList.contains("nav-link") && a.classList.replace("nav-link", "nav-icon"), a.classList.remove("collapsed", "menu-link");
        }), (b = (b = "/" == location.pathname ? "index.html" : location.pathname.substring(1)).substring(b.lastIndexOf("/") + 1)) && (!(b = document.getElementById("navbar-nav").querySelector('[href="' + b + '"]')) || ((a = b.closest(".collapse.menu-dropdown")) && (a.classList.add("show"), a.parentElement.children[0].classList.add("active"), a.parentElement.children[0].setAttribute("aria-expanded", "true"), a.parentElement.closest(".collapse.menu-dropdown") && (a.parentElement.closest(".collapse").classList.add("show"), a.parentElement.closest(".collapse").previousElementSibling && a.parentElement.closest(".collapse").previousElementSibling.classList.add("active"), a.parentElement.parentElement.parentElement.parentElement.closest(".collapse.menu-dropdown") && (a.parentElement.parentElement.parentElement.parentElement.closest(".collapse").classList.add("show"), a.parentElement.parentElement.parentElement.parentElement.closest(".collapse").previousElementSibling && a.parentElement.parentElement.parentElement.parentElement.closest(".collapse").previousElementSibling.classList.add("active")))))), 1, 1, 1);
    }
    ...
    function A(a) {
        ...
        if (a.target && a.target.matches("a.nav-link")) {
            if (0 == u(a.target.nextElementSibling))
                a.target.nextElementSibling.classList.add("dropdown-custom-right"), a.target.parentElement.parentElement.parentElement.classList.add("dropdown-custom-right"), (c = a.target.nextElementSibling), Array.from(c.querySelectorAll(".menu-dropdown")).forEach(function (a) {
                    a.classList.add("dropdown-custom-right");
                });
    ...
    function B() {
        var c, a, b = "/" == location.pathname ? "index.html" : location.pathname.substring(1);
    ...
    function D() {
        (document.getElementById("two-column-menu").innerHTML = ""), (document.querySelector(".sidebar").innerHTML = z), document.getElementById("two-col-bar").removeAttribute("data-simplebar"), document.getElementById("navbar-nav").removeAttribute("data-simplebar"), document.getElementById("two-col-bar").classList.remove("h-100");
        var a = document.querySelectorAll("ul.navbar-nav > li.nav-item"),
            b = "",
            c = "";
        Array.from(a).forEach(function (d, e) {
            e + 1 === 7 && (c = d), 7 < e + 1 && ((b += d.outerHTML), d.remove()), e + 1 === a.length && c.insertAdjacentHTML && c.insertAdjacentHTML("afterend", '<li class="nav-item">						<a class="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">							<i class="ri-briefcase-2-line"></i> More						</a>						<div class="collapse menu-dropdown" id="sidebarMore"><ul class="nav nav-sm flex-column">' +
                b +
                "</ul></div>					</li>");
        });
    }
    ...
    function n(a) {
        if (a == a) {
            switch (a["data-layout"]) {
                case "vertical":
                    G("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), s();
                    break;
                case "horizontal":
                    G("data-layout", "horizontal"), sessionStorage.setItem("data-layout", "horizontal"), document.documentElement.setAttribute("data-layout", "horizontal");
                    break;
                case "twocolumn":
                    G("data-layout", "twocolumn"), sessionStorage.setItem("data-layout", "twocolumn"), document.documentElement.setAttribute("data-layout", "twocolumn");
                    break;
                default:
            ...
            switch (a["data-sidebar-size"]) {
                ...
                case "sm-hover":
                    ...
                    break;
                default:
                    "sm" == sessionStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "sm"), G("data-sidebar-size", "sm"), sessionStorage.setItem("data-sidebar-size", "sm")) : "md" == sessionStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "md"), G("data-sidebar-size", "md"), sessionStorage.setItem("data-sidebar-size", "md")) : "sm-hover" == sessionStorage.getItem("data-sidebar-size") ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), G("data-sidebar-size", "sm-hover"), sessionStorage.setItem("data-sidebar-size", "sm-hover")) : (document.documentElement.setAttribute("data-sidebar-size", "lg"), G("data-sidebar-size", "lg"), sessionStorage.setItem("data-sidebar-size", "lg"));
            }
    ...
    function w() {
        setTimeout(function () {
            var c, b, a = document.getElementById("navbar-nav");
    ...
    function G(a, b) {
        Array.from(document.querySelectorAll("input[name=" + a + "]")).forEach(function (c) {
            b == c.value ? (c.checked = !0) : (c.checked = !1), c.addEventListener("change", function () {
                document.documentElement.setAttribute(a, c.value), sessionStorage.setItem(a, c.value), "data-layout-width" == a && "boxed" == c.value ? (document.documentElement.setAttribute("data-sidebar-size", "sm-hover"), sessionStorage.setItem("data-sidebar-size", "sm-hover"), (document.getElementById("sidebar-size-small-hover").checked = !0)) : "data-layout-width" == a && "fluid" == c.value && (document.documentElement.setAttribute("data-sidebar-size", "lg"), sessionStorage.setItem("data-sidebar-size", "lg"), (document.getElementById("sidebar-size-default").checked = !0));
            });
            ...
            1 == a.checked && new bootstrap.Collapse(b, {
                toggle: !1
            }).show(), document.querySelector("[data-bs-target='#collapseBgGradient']").addEventListener("click", function (a) {
    ...
    sessionStorage.getItem("defaultAttribute") ? (((b = {})["data-layout"] = sessionStorage.getItem("data-layout")), (b["data-sidebar-size"] = sessionStorage.getItem("data-sidebar-size")), (b["data-layout-mode"] = sessionStorage.getItem("data-layout-mode")), (b["data-layout-width"] = sessionStorage.getItem("data-layout-width")), (b["data-sidebar"] = sessionStorage.getItem("data-sidebar")), (b["data-layout-position"] = sessionStorage.getItem("data-layout-position")), (b["data-layout-style"] = sessionStorage.getItem("data-layout-style")), (b["data-topbar"] = sessionStorage.getItem("data-topbar")), n(b)) : ((a = document.documentElement.attributes), (b = {}), Array.from(a).forEach(function (a) {
    ...
    }), sessionStorage.setItem("defaultAttribute", JSON.stringify(b)), n(b), (a = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]')) && a.click()), t(), (j = document.getElementById("search-close-options")), (o = document.getElementById("search-dropdown")), (f = document.getElementById("search-options")) && (f.addEventListener("focus", function () {
    ...
    })), (g = document.getElementById("search-close-options")), (k = document.getElementById("search-dropdown-reponsive")), (d = document.getElementById("search-options-reponsive")), g && k && d && (d.addEventListener("focus", function () {
    ...
    }), document.addEventListener("fullscreenchange", h), document.addEventListener("webkitfullscreenchange", h), document.addEventListener("mozfullscreenchange", h), (p = document.getElementsByTagName("HTML")[0]), (a = document.querySelectorAll(".light-dark-mode")) && a.length && a[0].addEventListener("click", function (a) {
        ...
        a.addEventListener("click", function (a) {
            q--, this.closest(".dropdown-item-cart").remove(), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function (a) {
                a.innerHTML = q;
            }), x(), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = 0 == q ? "block" : "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = 0 == q ? "none" : "block");
        });
    }), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function (a) {
        a.innerHTML = q;
    }), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = "block"), x()), document.getElementsByClassName("notification-check") && Array.from(document.querySelectorAll(".notification-check input")).forEach(function (a) {
        a.addEventListener("click", function (a) {
    ...
    }), (a = document.querySelectorAll("[data-choices]")), Array.from(a).forEach(function (c) {
        var b = {},
            a = c.attributes;
        a["data-choices-groups"] && (b.placeholderValue = "This is a placeholder set in the config"), a["data-choices-search-false"] && (b.searchEnabled = !1), a["data-choices-search-true"] && (b.searchEnabled = !0), a["data-choices-removeItem"] && (b.removeItemButton = !0), a["data-choices-sorting-false"] && (b.shouldSort = !1), a["data-choices-sorting-true"] && (b.shouldSort = !0), a["data-choices-multiple-remove"] && (b.removeItemButton = !0), a["data-choices-limit"] && (b.maxItemCount = a["data-choices-limit"].value.toString()), a["data-choices-limit"] && (b.maxItemCount = a["data-choices-limit"].value.toString()), a["data-choices-editItem-true"] && (b.maxItemCount = !0), a["data-choices-editItem-false"] && (b.maxItemCount = !1), a["data-choices-text-unique-true"] && (b.duplicateItemsAllowed = !1), a["data-choices-text-disabled-true"] && (b.addItems = !1), a["data-choices-text-disabled-true"] ? new Choices(c, b).disable() : new Choices(c, b);
    }), (a = document.querySelectorAll("[data-provider]")), Array.from(a).forEach(function (d) {
        var c, b, a;
    ...
    }), r(null === l ? "en" : l), (e = document.getElementsByClassName("language")), e && Array.from(e).forEach(function (a) {
        a.addEventListener("click", function (b) {
            r(a.getAttribute("data-lang"));
        });
    }), s(), w(), window.addEventListener("resize", function () {
