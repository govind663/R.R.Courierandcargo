...
class ParcelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        if ($this->id){
            $rule = [
                ...
                'within_mumbai_thane'=> __('required|numeric'),
                'surface'=> __('required|numeric'),
    ...
    public function messages()
    {
        return [
            ...
            'within_mumbai_thane.required' => __('Please Select Within Mumbai/Thane'),
            'surface.required' => __('Please Select Surface'),
